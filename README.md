...
![EKS Architecture](eks_architecture.png)

### IRSA and Storage Flow

![IRSA Storage Flow](irsa_storage_flow.png)

### Component Breakdown

**Infrastructure Layer:**
- **VPC**: Custom VPC (10.0.0.0/16) with public/private subnets across 3 AZs
- **NAT Gateway**: Single NAT for cost optimization
- **Internet Gateway**: Public internet access
- **Worker Nodes**: 3x t3.micro EC2 instances in private subnets

**Control Plane:**
- **EKS Cluster**: Managed Kubernetes 1.31
- **OIDC Provider**: Enables IRSA for secure pod authentication
- **IAM Roles**: Pod-level AWS permissions without static credentials

**Storage:**
- **EFS**: Shared file system (ReadWriteMany) for multi-pod access
- **EBS**: Persistent block storage (ReadWriteOnce) for stateful apps
- **CSI Drivers**: Kubernetes integration for dynamic provisioning

**Secrets:**
- **Secrets Manager**: Centralized secret storage with rotation
- **CSI Driver**: Mounts secrets as files in pods
- **Auto-Sync**: Kubernetes secrets synced from Secrets Manager
